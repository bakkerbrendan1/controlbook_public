...
controller = ctrlPID()
psi_ref = SignalGenerator(amplitude=30.*np.pi/180., frequency=0.025) # yaw
theta_ref = SignalGenerator(amplitude=15.*np.pi/180., frequency=0.025) # pitch
...
disturbance = SignalGenerator(amplitude=0.05, frequency=0.0)

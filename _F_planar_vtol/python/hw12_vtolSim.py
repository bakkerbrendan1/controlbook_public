...
from ctrlStateFeedbackInt_hwF12 import ctrlStateFeedbackInt
import matplotlib
matplotlib.use('tkagg')

# instantiate satellite, controller, and reference classes
VTOL = VTOLDynamics(alpha=0.2)
controller = ctrlStateFeedbackInt()
...
while t < P.t_end:  # main simulation loop
    ...
    while t < t_next_plot:  
        ...
        h_dis = h_disturbance.step(t)  # reference input
        z_dis = z_disturbance.step(t)
